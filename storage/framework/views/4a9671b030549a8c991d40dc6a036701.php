                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Sign in to continue to Student Analysis System.</p>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <form class="form-horizontal" method="POST" action="<?php echo e(route('login')); ?>">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="username" type="username" class="form-control <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('username')); ?>" id="username" placeholder="Enter Username" autocomplete="username" autofocus>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> Developed by Silicon Hub Pvt. Ltd.</p>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/studentanalysis/riastudentanalysis/resources/views/auth/login.blade.php ENDPATH**/ ?>