            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="dataDebug" style="display: none;">
                        ...
                        <p>Grades Count: {{ !empty($grades) ? count($grades) : 0 }}</p>
                        <p>Streams Count: {{ !empty($streams) ? count($streams) : 0 }}</p>
                    </div>

                    @if (empty($grades) || empty($streams))
...
@section('script')
    ...
    <script src="{{ URL::asset('build/js/pages/grade-stream-subjects.init.js') }}"></script>
